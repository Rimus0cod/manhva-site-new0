  ...
  <header class="header">
    <nav>
      <div class="logo-container">
        ...
        <a href="/public/tokyo ghoul;re/index.html">Tokyo Ghoul</a>
      </div>
    </nav>
    <nav class="navbar">
      <a href="#">Закладки</a>
...
<div class="nav-bar">
  ...
  <div class="images">
    ${images.map((img) => `<img src="https://storage.googleapis.com/chapters-for-manga/tokyo-ghoul%3Are-chapters/chapters/${chapterNumber}/images/${img}" alt="Страница">`).join('\n')}
  </div>
